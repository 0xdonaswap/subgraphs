...
import { Bundle, Pair, DonaswapFactory, Token } from "../generated/schema";
...
export function handlePairCreated(event: PairCreated): void {
  let factory = DonaswapFactory.load(FACTORY_ADDRESS);
  if (factory === null) {
    factory = new DonaswapFactory(FACTORY_ADDRESS);
