...
export function handleSwap(event: SwapEvent): void {
  ...
  donaswapDayData.volumeETH = donaswapDayData.volumeETH.plus(volumeETH);
  donaswapDayData.volumeUSD = donaswapDayData.volumeUSD.plus(volumeUSD);
  donaswapDayData.feesUSD = donaswapDayData.feesUSD.plus(feesUSD);
  donaswapDayData.protocolFeesUSD = donaswapDayData.protocolFeesUSD.plus(protocolFeeAmounts.usd);
