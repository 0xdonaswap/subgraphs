...
export function updateDonaswapDayData(event: ethereum.Event): DonaswapDayData {
  let donaswap = Factory.load(FACTORY_ADDRESS);
  ...
  if (donaswapDayData === null) {
    ...
    donaswapDayData.volumeETH = ZERO_BD;
    donaswapDayData.volumeUSD = ZERO_BD;
    donaswapDayData.volumeUSDUntracked = ZERO_BD;
    donaswapDayData.feesUSD = ZERO_BD;
    donaswapDayData.protocolFeesUSD = ZERO_BD;
  }
  donaswapDayData.tvlUSD = donaswap.totalValueLockedUSD;
  donaswapDayData.txCount = donaswap.txCount;
